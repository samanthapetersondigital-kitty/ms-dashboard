...
const PASSWORD = "str2026";

function PasswordGate({ children }) {
  const [authed, setAuthed] = useState(() => sessionStorage.getItem("ms_auth") === "1");
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: "#060f1a" }}>
      <div style={{ background: "#091929", border: "1px solid #1e3a5f", borderRadius: 12, padding: "40px 48px", minWidth: 320, textAlign: "center" }}>
        <div style={{ fontSize: 22, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Marilyn Strickland Dashboard</div>
...
const FINANCES = [
  ...
  },
  {
    "period": "2026-01",
    "type": "month",
    "totalActBlue": 26547.0,
    "digitalRaise": 4687.0
  },
  {
    "period": "2026-02",
    "type": "month",
    "totalActBlue": 14593.5,
    "digitalRaise": 1997.0
  },
  {
    "period": "2026-03",
    "type": "month",
    "totalActBlue": 33862.5,
    "digitalRaise": 5361.0
  },
  {
    "period": "2026-04",
...
const FINANCE_QUARTERLY = {
  period: "Q2 2026",
  totalActBlue: 95059.5,
  digitalRaise: 19816.0,
  projection: 109318,
};
      ...
      <div style={{ minHeight: "100vh", background: "#060f1a", color: "#e2e8f0", fontFamily: "'Inter', sans-serif" }}>
        ...
        <header style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(6,15,26,0.96)", backdropFilter: "blur(12px)", borderBottom: "1px solid #1e3a5f", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ width: 36, height: 36, borderRadius: 8, background: "linear-gradient(135deg,#1d4ed8,#3b82f6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, fontWeight: 800, fontFamily: "'Sora', sans-serif", color: "#fff" }}>{"MS"}</div>
            <div>
