// ============================================================
// Marilyn Strickland Dashboard — App.jsx
...
const DATA = {
  ...
  finances: {
    totalRaised: 95059.5,
    emailDigital: 19816.0,
    smsDigital: 0.0,
    digitalTarget: 0.10,
    byMonth: [
      { month: "2025-11", total: 12044.0, digital: 4496.0 },
      { month: "2025-12", total: 6950.0, digital: 3047.0 },
      { month: "2026-01", total: 26547.0, digital: 4687.0 },
      { month: "2026-02", total: 14593.5, digital: 1997.0 },
      { month: "2026-03", total: 33862.5, digital: 5361.0 },
      { month: "2026-04", total: 1062.5, digital: 228.0 }
    ],
  },
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Marilyn Strickland — Digital Dashboard ({DATA.period})
      </h1>
